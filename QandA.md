...
- `final_answer`は非公開
- `claims[]`の`text`、`importance`、`status`を表示
- Evidenceはタイトル、発行元、URL、対応関係の概要まで表示
- `contradicted`、`conflicting`、`unverified`の理由を表示
...
*最終更新: 2026-07-11 — U-1（withheld開示範囲）追加。既回答41問、未回答40問（既存27＋クラス設計7＋テスト設計5＋開示境界1）*
